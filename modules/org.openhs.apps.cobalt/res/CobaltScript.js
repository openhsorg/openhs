...
var Panel = (function () {
    ...
    Panel.prototype.paint = function () {
        ...
        var ept = "X: " + this.robot.m_endGrab.point.x.toPrecision(7) + "  Y: " + this.robot.m_endGrab.point.y.toPrecision(7) + "  Z: " + this.robot.m_endGrab.point.z.toPrecision(7);
        ctx.fillText(ept.toString(), 120, 60);
        //Axes of robot
        var ept = "Ax1: " + this.robot.m_axisArray[1].fi.toPrecision(4) + "  Ax2: " + this.robot.m_axisArray[2].fi.toPrecision(4) + "  Ax3: " + this.robot.m_axisArray[3].fi.toPrecision(4);
