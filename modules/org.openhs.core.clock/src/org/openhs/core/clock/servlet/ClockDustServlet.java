...
public class ClockDustServlet extends HttpServlet {
	
	String address = "org.openhs.core.clock.servlet.ClockDustServlet";
	String addressHome = "/";
	String addressPrev = "/";
	String addressNext = "/";		
	 ...
	 @Override
	    ...
	    //	out.println("<script src='org.openhs.core.clock.servlet.res/jquery-3.1.1.min.js'></script>");
	    	out.println("<link href='org.openhs.core.clock.servlet.res/clockdust/styles.css' rel='stylesheet' type='text/css'>");		    	    	
	    	...
	    	out.println("<canvas id='canvas' class=canvasScreen charset='utf-8' width='500' height='500' style='margin-top: -250px; margin-left: -250px'>");		    			    	
	    	out.println("Error: Your browser does not support the HTML canvas element.");
	    	out.println("</canvas>");
	    	
	    	out.println("<script id='dustscript' src='org.openhs.core.clock.servlet.res/clockdust/clock.js' next='" + addressNext +"' charset='utf-8'></script>");
